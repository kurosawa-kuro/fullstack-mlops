...
class Config(BaseSettings):
    ...
    db_path: str = Field(default="models/trained/house_price_dwh.duckdb", description="データベースパス")
    
    # MLflow設定
    mlflow_tracking_uri: str = Field(default="http://localhost:5555", description="MLflow追跡URI")
    mlflow_experiment_name: str = Field(default="house_price_prediction", description="MLflow実験名")
