...
def _scale_features(df):
    ...
    scale_features = [
        ...
        'price_bedrooms_interaction', 'price_bathrooms_interaction',
        'sqft_bedrooms_interaction', 'location_avg_price', 'price_vs_location_avg'
    ]
    ...
    if available_features:
        ...
        df_scaled = pd.DataFrame(df_scaled, columns=[f"{f}_scaled" for f in available_features], index=df.index)
